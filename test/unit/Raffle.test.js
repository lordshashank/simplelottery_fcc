...
!developmentChains.includes(network.name)
    ...
    : describe("Raffle", function () {
          let raffle, raffleContract, vrfCoordinatorV2Mock, raffleEntranceFee, interval, player // , deployer          const chainId = network.config.chainId
          beforeEach(async () => {
              ...
              // fixtures allows deplotying entire deploy folder with all tags
              accounts = await ethers.getSigners() // could also do with getNamedAccounts
              //   deployer = accounts[0]
              player = accounts[1]
              await deployments.fixture(["all"])
              raffleContract = await ethers.getContract("Raffle", player)
          ...
          describe("constructor", function () {
              it("initializes the raffle constructor", async function () {
